                            ...
                            <div class="card-body">
                                ...
                                <form  action="{{route('linh-vuc.cap-nhat-linh-vuc',$linh_vuc->id)}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Linhvuc"  placeholder="Gõ tên lĩnh vực" value="{{$linh_vuc->ten_linh_vuc}}" readonly="readonly">

                                         <label for="Linhvuc">Tên lĩnh vực mới</label>
                                        <input type="text" class="form-control" id="Linhvuc" name="ten_linh_vuc" placeholder="Gõ tên lĩnh vực">
